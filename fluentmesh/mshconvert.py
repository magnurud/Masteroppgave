...
def convert(fluentmesh, 
            ...
            cylindrical=1, NZ=1,reafile='def.rea',outfile='out.rea'):                      # semtex  only
    ...
    #passive_scalars = [] or list of dictionaries of boundary conditions for
        ...
        # reafile is the .rea file from where parameters and settings are copied
# ADDED BY RUD 23.09.15
# This part is just a default that goes into the top of the rea-file:
	if (reafile != 'def.rea'): 
