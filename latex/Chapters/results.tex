...
As a test of the algorithm described in~\cref{surfpro} a mesh was created based on the hill of Ekeberg in Oslo 
...
filtering was greatly reduced. This effect is captured in~\fref{fig:maxvel} which shows how 
