...
The inflow conditions had to be mapped onto the boundary at each time step. To mimic the situation in the wind-tunnel the velocity field
...
is presented in~\tref{tab:perfgas}
%
\begin{table}[h]
    \centering
    \begin{tabular}{c l }
...
%   Alias   0.013  -2.50363621e+01
%   Char    0.000  -1.22425816e+01
%   default 0.001.61349516e-03  -1.22431699e+01
%   filter  8.43539472e-01  -1.26292235e+01
%   P_NP_N  9.33531436e-02  -6.23979364e+00


%   Alias   1.32183732e-02  -2.50363621e+01
%   Char    1.00237174e-04  -1.22425816e+01
%   default 1.61349516e-03  -1.22431699e+01
%   filter  8.43539472e-01  -1.26292235e+01
%   P_NP_N  9.33531436e-02  -6.23979364e+00
...
\begin{figure}[h]
	\centerline{
        \includegraphics[trim=0.5cm 4cm 0.5cm 7cm, width=0.8\textwidth]{Figures/scalresults.pdf}}
	\caption{The logarithm of the error plotted against the polynomial degree. All results 
        are with $P_NP_{N-2}$ and dealiasing, and they are solved without using the 
    characteristic scheme or any filtering. A line illustrating a second order convergence is 
    plotted to illustrate the convergence rate.}
