...
how the program is built up from the bottom up. 
%
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{Figures/filestructure.png}
...
applied for the implementations in this thesis are stated in Appendx~\ref{AppendixB}.
