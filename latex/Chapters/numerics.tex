...
\begin{align}
    ...
    \label{eq:Legendre}
\end{align}
With equations \ref{eq:GLL-nodes} and \ref{eq:Legendre} the basis functions $\psi_j$ can be stated as 
\begin{align}
...
Creating a basis for 2 and 3 dimensions is done simply by taking the tensor product of the basis functions in each direction
\begin{align}
