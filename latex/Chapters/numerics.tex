...
Although SEM provides spectral convergence in spatial approximation and 2nd or 3rd order accuracy
in time the stability of a straight forward implementation is not guaranteed, spurious nodes appear 
