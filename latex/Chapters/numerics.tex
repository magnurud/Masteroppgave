...
The weak formulation in equation\eref{eq:Helmholtzweak} can then be written according 
...
Notice the resemblence to the application of the filter in\eref{eq:filterstepwise}. The second step
