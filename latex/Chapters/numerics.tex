...
solve the equations. This chapter aims to give a more detailed description of the solution methods applied.
...
\begin{theorem}
    ...
    \begin{equation}
        \inf_{v_h\in \mathbb{P}_N}||u-v_h||_1 \le CN^{1-\sigma}||u||_{\sigma}.
    \end{equation}
...
repeated here, $X^N_k =  H_0^1(\Omega_k)\bigcap\mathbb{P}_N(\Omega_k)$, and 
$\mathbb{P}_{N,K} = \left\{ v \in L^2(\Omega),v_{|\Omega_k} \in \mathbb{P}_N(\Omega_K) \right\}$.
\begin{theorem}
