...
This method provides an efficient algorithm, and by doing an incremental version 
...
Notice that the error surging from the splitting in \eref{eq:LUfactorization}
