...
The boundary conditions are not stated explicitly with in\eref{eq:NS} because they depend on the physical 
...
Applying the $b$ filter on the first tensor in eq\eref{eq:stresstensors} allows us to define 
