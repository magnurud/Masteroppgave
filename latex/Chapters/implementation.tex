...
Let $\left\{ \mathbf{x} \right\}_m$ be the $m$ closest in the sense of the norm defined by~\eref{eq:distancenorm},
...
given in the list below, for additional minor routines implemented see Appendix~\ref{surfaceprojection}
\begin{itemize}
...
\begin{figure}[h]
    \centering
  \includegraphics[width=0.8\linewidth]{Figures/helicopter.jpg}
...
\begin{figure}[h]
    \centering
  \includegraphics[width=0.8\linewidth]{Figures/mesh_ekeberg.jpg}
