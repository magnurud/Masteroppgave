...
called ''myFlow'', and the mesh and surface mesh created in ICEM are named mesh_myFlow and 
surfmesh_myFlow. The following commands are then executed
\begin{verbatim}
>> ~/path/to/meshconvert/scrpt/nmshconvert --mesh mesh_myFlow --reafile init.rea --outfile myFlow.rea
