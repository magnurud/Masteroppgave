...
As a test-problem the hill of Ekeberg was applied. 
...
of the channel. This is a rather specific averaging routine based on the assumption of homogeneous turbulence 
